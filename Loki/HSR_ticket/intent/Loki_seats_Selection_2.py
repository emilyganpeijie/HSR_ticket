...
"""
    Loki module for seats_Selection_2
...
if CHATBOT_MODE:
    try:
        responseDICT = json.load(open(os.path.join(os.path.dirname(os.path.dirname(__file__)), "reply/reply_seats_Selection_2.json"), encoding="utf-8"))
    except Exception as e:
...
def debugInfo(inputSTR, utterance):
    if DEBUG:
        print("[seats_Selection_2] {} ===> {}".format(inputSTR, utterance))
